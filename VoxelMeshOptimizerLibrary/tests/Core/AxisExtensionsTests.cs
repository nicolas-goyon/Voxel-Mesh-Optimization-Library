...
public class AxisExtensionsTests
{
    ...
    public void GetDepthFromAxis_Ascending_ReturnsCoordinateValue_ForAxisX()
    {
        ...
        Chunk chunk = ChunkGen.GenerateChunk(10, 20, 30);
        uint x = 3, y = 5, z = 7;
    ...
    {
        // Arrange: Create a TestChunk.
        Chunk chunk = ChunkGen.GenerateChunk(8, 8, 8);
    ...
    {
        // Arrange
        Chunk chunk = ChunkGen.GenerateChunk(10, 10, 10);
    ...
    public void DefineIterationOrder_ForMajorAxisX_ReturnsExpectedMapping()
    {
        ...
        // Act:
        (Axis major, AxisOrder majorOrder, Axis middle, AxisOrder middleOrder, Axis minor, AxisOrder minorOrder) iterationOrder = AxisExtensions.DefineIterationOrder(majorAxis, order);
    ...
    public void DefineIterationOrder_InvalidNonDistinctAxes_ThrowsException()
    {
        ...
        Chunk chunk = ChunkGen.GenerateChunk(5, 5, 5);
    ...
    public void GetSlicePlanePosition_Ascending_ReturnsSameAbsoluteCoordinates()
    {
        ...
        // Act:
        (uint planeX, uint planeY) slicePos = AxisExtensions.GetSlicePlanePosition(
    ...
    public void GetSlicePlanePosition_MixedOrders_SliceOrderDoesNotInfluenceOutput()
    {
        ...
        // Act:
        (uint planeX, uint planeY) slicePosA = AxisExtensions.GetSlicePlanePosition(
            sliceAxis, sliceOrderA,
            planeAxis1, planeAxis1Order,
            planeAxis2, planeAxis2Order,
            x, y, z, chunk);

        (uint planeX, uint planeY) slicePosB = AxisExtensions.GetSlicePlanePosition(
